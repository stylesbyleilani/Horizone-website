...
//           <img src="/m5.jpg" alt="" className='w-[900px] h-[220px] rounded-md object-cover' />
...
//             <div className='p-2 bg-white/10 backdrop-blur-sm text-white rounded-full '>
...
//             <p className='text-white'>With Terms and Condition</p>
//           </div>
//         </div>

//         <div className="relative">
//           <img src="/m6.jpg" alt="" className='w-[900px] h-[220px] rounded-md object-cover' />
//           <div className="absolute inset-0 bg-black/60 rounded-md" />
//           <div className="absolute inset-0 p-4 flex  justify-between">
//             <CircleXIcon className="text-white" />
//             <div className='p-2 bg-white/10 backdrop-blur-sm text-white rounded-full w-fit'>
...
const Promo = () => { 
 return (
   <div className='bg-white p-5 text-gray-950'>
     ...
     <div className="flex gap-4 md:flex-row flex-col">
       <div className="relative">
         <img src="/m18.jpg" alt="" className='w-[900px] h-[220px] rounded-md object-cover' />
         <div className="absolute inset-0 bg-black/60 rounded-md" />
       ...
       <div className="relative">
         <img src="/m21.jpg" alt="" className='w-[900px] h-[220px] rounded-md object-cover' />
         <div className="absolute inset-0 bg-black/60 rounded-md" />
         <div className="absolute inset-0 p-4 flex flex-col justify-between">
           <div className="flex justify-between">
              <div className="div p-1 w-8 h-8 bg-amber-300 rounded-full items-center  text-gray-900"><CircleXIcon className='text-sm'/></div>
     ...
     <div className='mt-6 p-2 flex gap-2 justify-between items-center'>
